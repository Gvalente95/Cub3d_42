...
//	if no pokemons available, returns 1 and we shouldnt call other Transitions
bool	handle_my_pkmn_ko(t_md* md, t_BA_d* bd)
{
...
//	if no pokemons available, returns 1 and we shouldnt call other Transitions
//	To know if we should switch turn, we need to check current turn, 
